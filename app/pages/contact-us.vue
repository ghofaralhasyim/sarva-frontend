...
<template>
  ...
  >
    <div class="">
      ...
      <p class="text-black/50 mt-6 lg:mt-8">Phone</p>
      <p class="lg:text-xl mt-1">+62-8123-4567-8901</p>
      <p class="text-black/50 mt-6 lg:mt-8">Whatsapp</p>
      <p class="lg:text-xl mt-1">+62-8123-4567-8901</p>
    ...
    <div class="bg-sarva-green px-6 pt-10 pb-16 lg:p-10 text-white">
      <h2 class="font-serif text-[36px] lg:text-[42px] mt-4 leading-[42px]">
        Contact Form
      </h2>
      <div class="mt-8">
